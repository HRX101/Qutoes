...
<nav class="navbar navbar-expand  bg-dark" style="border:none;box-shadow:0 2px 2px black;font-size:20px;outline:none;color:white;">
  <div class="container-fluid">
    ...
    <div  class="head" style="box-sizing:box-border;text-align:center;padding:50px;background-color: #b8c6db;
background-image: linear-gradient(315deg, #b8c6db 0%, #f5f7fa 74%);box-shadow:0 2px 2px black;">
...
background-image: linear-gradient(315deg, #2f4353 0%, #d2ccc4 74%);font-weight:bold;color:black;color:black;">Enter your qutoes :
            <br>
            <textarea placeholder="Enter your qutoes" rows="10" cols="50" name="qutoes" style="border-radius:10px 10px;background-color: #2d3436;
background-image: linear-gradient(315deg, #2d3436 0%, #000000 74%);color:white;font-family:'Times New Roman',Times,serif"></textarea>
            </label>
...
<br>
<br>
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top" style="height:100px;position:absolute;left:0;bottom:0;background-color: #ffeaa7;
