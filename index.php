...
<body>
        ...
        <navbar  >
        <a href="#" style="position:absolute;top:20px;padding:auto;background-color:white;box-shadow:0 4px 4px white;border-radius:20px 20px;color:black;text-decoration:none;font-size:40px;left:40%;"> Home</a>
