  ...
  <tbody>
      ...
      if($result!==FALSE && $result->num_rows>0){
        while($row=$result->fetch_assoc()){
          ...
          echo "<tr>"."<td>"."<p style='color:black;family-weight:bold;font-style:italic;'>"."<q>".$row['qutoes']."</q>"."</p>"."</td>"."<td>".$row['Name']."</td>"."<td>"."<a href='delete.php' class='btn'>"."close"."</a>"."</td>"."</tr>";
          }
          else{
            echo "<tr>"."<td>"."<p style='color:black;family-weight:bold;font-style:italic;'>"."<q>".$row['qutoes']."</q>"."</p>"."</td>"."<td>".$row['Name']."</td>"."<td>"."only admin can delete"."</td>"."</tr>";
          }
        }
      }
      else{
